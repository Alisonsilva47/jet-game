...
jet_2 = pygame.image.load('sprites/jet_2.png')
...
enemy_jet_2 = pygame.image.load('sprites/enemy_jet_2.png')
boat = pygame.image.load('sprites/tank.png')
heart = pygame.image.load('sprites/heart.png')

jet_list = [jet_1, jet_2]
damage_jet_list = [jet_damaged_1, jet_damaged_2]
enemy_jet_list = [enemy_jet_1, enemy_jet_2]
...
all_sprites = [jet_1, jet_2, jet_damaged_1, jet_damaged_2, enemy_jet_1,
               enemy_jet_2, explosion_0, explosion_1, explosion_2, explosion_3, explosion_4, explosion_5,
               explosion_6, explosion_7, boat, atomic_bomb, spaceship, icon, background, cloud]
